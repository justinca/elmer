...
_COLUMN_CANDIDATES: dict[str, list[str]] = {
    "call":       ["Call", "CALL", "call", "Callsign", "CALLSIGN"],
    "band":       ["Band", "BAND", "band"],
    ...
    "rst_sent":   ["RSTSent", "RST_SENT", "rst_sent", "RST_Sent"],
    "rst_rcvd":   ["RSTRcvd", "RST_RCVD", "rst_rcvd", "RST_Rcvd"],
    ...
    "cq_zone":    ["CQZone", "CQ_ZONE", "cq_zone", "CQZ"],
    "itu_zone":   ["ITUZone", "ITU_ZONE", "itu_zone"],
    "state":      ["State", "STATE", "state", "US_State"],
    "county":     ["County", "COUNTY", "county"],
    "power":      ["Power", "POWER", "power", "TX_Power", "TXPower"],
