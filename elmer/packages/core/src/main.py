...
from .routes import agents, allstar, chat, contest, docs, dx, health, homeassistant, knowledge, llm, log, meshtastic, nodes, notes, pota, propagation, search, transcription
...
app.include_router(allstar.router)
